                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="right-bars col-xs-10 col-sm-10 col-md-10 col-lg-10" id="pm-r" style="display: none;">
                             ...
                             <?php
                            include "database.php"; 
                            $queryForProduct="select * from product where product_cat='diabetic' ";
...
<!--
                                <div class="center-product col-xs-12 col-sm-5 col-md-4 col-lg-4">
                                ...
                                <div class="right-product col-xs-12 col-sm-5 col-md-4 col-lg-4">
